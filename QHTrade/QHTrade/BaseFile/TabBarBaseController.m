...
- (void)viewDidLoad
{
    ...
    NSDictionary *attrs =@{NSForegroundColorAttributeName:[UIColor colorWithRed:138.0/255.0 green:138.0/255.0 blue:138.0/255.0 alpha:1.0f],NSFontAttributeName:[UIFont rdSystemFontOfSize:12]};
    
    
    NSDictionary *selectedAttrs = @{NSFontAttributeName:[UIFont rdSystemFontOfSize:12],NSForegroundColorAttributeName:[UIColor colorWithRed:63.0/255.0 green:152.0/255.0 blue:243.0/255.0 alpha:1.0f]};
    ...
    // 添加子控制器
    [self setupChildVc:[[HomeViewController alloc] init] title:@"瑞达" image:@"icon_tabBarHome_defult" selectedImage:@"icon_tabBarHome_selected"];
