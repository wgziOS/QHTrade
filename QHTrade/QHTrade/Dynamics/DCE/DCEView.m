...
#import "DCEHeadView.h"

@interface DCEView()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic,strong)UITableView *table;
@property(nonatomic,strong)UIView *headView;
@property(nonatomic,strong)DCEHeadView *dynamicsSectionView;
@property(nonatomic,strong)DCEViewModel *buttonClickViewModel;

@end

@implementation DCEView
...
-(DCEViewModel *)buttonClickViewModel{
    if (!_buttonClickViewModel) {
        _buttonClickViewModel = [[DCEViewModel alloc] init];
    }
    return _buttonClickViewModel;
}
-(DCEHeadView *)dynamicsSectionView{
    if (!_dynamicsSectionView) {
        _dynamicsSectionView = [[DCEHeadView alloc] initWithViewModel:self.buttonClickViewModel];
    }
