...
#import "CFFEXHeadView.h"

@interface CFFEXView()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic,strong)UITableView *table;
@property(nonatomic,strong)UIView *headView;
@property(nonatomic,strong)CFFEXHeadView *dynamicsSectionView;
@property(nonatomic,strong)CFFEXViewModel *buttonClickViewModel;

@end

@implementation CFFEXView
...
-(CFFEXViewModel *)buttonClickViewModel{
    if (!_buttonClickViewModel) {
        _buttonClickViewModel = [[CFFEXViewModel alloc] init];
    }
    return _buttonClickViewModel;
}
-(CFFEXHeadView *)dynamicsSectionView{
    if (!_dynamicsSectionView) {
        _dynamicsSectionView = [[CFFEXHeadView alloc] initWithViewModel:self.buttonClickViewModel];
    }
