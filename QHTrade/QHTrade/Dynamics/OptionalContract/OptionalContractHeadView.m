...
@interface OptionalContractHeadView()
...
@implementation OptionalContractHeadView
...
-(instancetype)initWithViewModel:(id<BaseViewModelProtocol>)viewModel{
    self.buttonClickViewModel = (OptionalContractViewModel *)viewModel;
